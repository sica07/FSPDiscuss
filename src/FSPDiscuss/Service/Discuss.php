...
use FspDiscuss\Model\Message\MessageInterface,
    FspDiscuss\Model\Message\MessageMapperInterface,
    FspDiscuss\Model\Thread\ThreadInterface,
    FspDiscuss\Model\Thread\ThreadMapperInterface,
    FspDiscuss\Model\Tag\TagInterface,
    FspDiscuss\Model\Tag\TagMapperInterface,
...
class Discuss implements ServiceManagerAwareInterface
{
    ...
    public function createMessage(array $data, $thread)
    {
        ...
        $message = $this->getServiceManager()->get('fspdiscuss_message');
        $message->setThread($thread);

        // Create new form and hydrator objects.
        $form = $this->getServiceManager()->get('fspdiscuss_form');
        $formHydrator = $this->getServiceManager()->get('fspdiscuss_post_form_hydrator');
